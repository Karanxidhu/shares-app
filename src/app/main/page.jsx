...
function Home() {
    ...
    const handleSubmit = async (e) => {
        try {
            const response = await fetch('https://sharesb.karanxd.space/api/message/add', {
                method: "POST",
                headers: {
    ...
    const getData = async () => {
        setLoading(true);
        const response = await fetch('https://sharesb.karanxd.space/api/message/getall', {
            method: "get",
            headers: {
                "token": localStorage.getItem('token')
            }
    ...
    const handleDelete = async (id) => {
        const response = await fetch('https://sharesb.karanxd.space/api/message/delete/' + id, {
            method: "post",
            headers: {
                "token": localStorage.getItem('token')
            }
